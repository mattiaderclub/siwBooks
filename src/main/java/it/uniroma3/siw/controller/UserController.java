...
public class UserController {
	...
	public String modificaProfilo(@PathVariable("id") Long id,
			@Valid @ModelAttribute("updateUserDTO") UpdateUserDTO updateUserDTO, BindingResult bindingResult,
		...
		if (newPassword != null && !newPassword.isBlank()) {
			if (newPassword.length() < 6) {
				model.addAttribute("passwordError", "La password deve contenere almeno 6 caratteri");
				model.addAttribute("credentials", cred);
				return "utente/formModificaProfilo";
			}
