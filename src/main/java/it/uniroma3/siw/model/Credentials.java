 ...
 * Contiene informazioni come username, password e ruolo associato.
 * È associata in maniera univoca a un'entità User.
 */
@Entity
public class Credentials {
	...
	/**
     * Associazione 1 a 1 verso l'entità User.
     * Viene caricata eager e cascata tutte le operazioni (persist, remove, etc.).
     */
